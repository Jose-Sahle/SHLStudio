...
namespace GPRotina.DAL
{
	public static class SQLHelper
	{
		...
		{
			#if(!DEBUG)
				return @"Data Source=192.168.56.2;Initial Catalog=prodiggr;User ID=sa;pwd=shl@shls1h2l3";
			#else
				return @"Data Source=192.168.56.2;Initial Catalog=prodiggr;User ID=sa;pwd=shl@shls1h2l3";
			#endif
		}
		...
		#region ExecuteNonQuery functions
			...
			public static Int64 ExecuteNonQuery(String commandText, ArrayList parameters, SqlConnection connection, String ReturnParameter)
			{
				...
				parameters.Add(new SqlParameter(ReturnParameter, SqlDbType.BigInt, 8, ParameterDirection.Output, false, 19, 0, "IdReturn", DataRowVersion.Proposed, null));
