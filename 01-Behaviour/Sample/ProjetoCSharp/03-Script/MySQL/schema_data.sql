...
INSERT INTO GP_ROTINA (`idRotina`,`Nome`,`Decricao`,`DataCriacao`,`Usuario`,`Funcional`,`Ativo`,`Apelido`) VALUES (2,'TJBAProjudi','Robo Projudi','2012-03-05 00:00:00',NULL,NULL,0,NULL) ;
INSERT INTO GP_ROTINA (`idRotina`,`Nome`,`Decricao`,`DataCriacao`,`Usuario`,`Funcional`,`Ativo`,`Apelido`) VALUES (4,'Distribuidor-PainelAutomator','Robo Importação Fila O9','2012-03-05 00:00:00',NULL,NULL,0,NULL) ; 
INSERT INTO GP_ROTINA (`idRotina`,`Nome`,`Decricao`,`DataCriacao`,`Usuario`,`Funcional`,`Ativo`,`Apelido`) VALUES (6,'SaneamentoPilotoPCES','Saneamento do diretório Piloto PCES','2012-03-05 00:00:00',NULL,NULL,0,NULL) ; 
INSERT INTO GP_ROTINA (`idRotina`,`Nome`,`Decricao`,`DataCriacao`,`Usuario`,`Funcional`,`Ativo`,`Apelido`) VALUES (7,'TJSudesteAutomator','TJAutomator dos estados da região Sudeste','2012-03-05 00:00:00',NULL,NULL,1,NULL) ; 
INSERT INTO GP_ROTINA (`idRotina`,`Nome`,`Decricao`,`DataCriacao`,`Usuario`,`Funcional`,`Ativo`,`Apelido`) VALUES (8,'TJNorteAutomator','TJAutomator dos estados da região Norte','2012-03-05 00:00:00',NULL,NULL,0,NULL) ; 
INSERT INTO GP_ROTINA (`idRotina`,`Nome`,`Decricao`,`DataCriacao`,`Usuario`,`Funcional`,`Ativo`,`Apelido`) VALUES (9,'TJNordesteAutomator','TJAutomator dos estados da região Nordeste','2012-03-05 00:00:00',NULL,NULL,0,NULL) ; 
INSERT INTO GP_ROTINA (`idRotina`,`Nome`,`Decricao`,`DataCriacao`,`Usuario`,`Funcional`,`Ativo`,`Apelido`) VALUES (10,'TJCentroOesteAutomator','TJAutomator dos estados da região Centro-Oeste','2012-03-05 00:00:00',NULL,NULL,0,NULL) ; 
INSERT INTO GP_ROTINA (`idRotina`,`Nome`,`Decricao`,`DataCriacao`,`Usuario`,`Funcional`,`Ativo`,`Apelido`) VALUES (11,'TJSulAutomator','TJAutomator dos estados da região Sul','2012-03-05 00:00:00',NULL,NULL,0,NULL) ; 
...
SET FOREIGN_KEY_CHECKS=0;
INSERT INTO GP_AGENDAMENTO (`idAgendamento`,`idRotina`,`DataInicio`,`HoraInicio`,`DataFim`,`HoraFim`,`Intervalo`,`Repeticao`) VALUES (2,2,'2012-03-05 00:00:00','8:01',NULL,'20:01',30,0) ; 
INSERT INTO GP_AGENDAMENTO (`idAgendamento`,`idRotina`,`DataInicio`,`HoraInicio`,`DataFim`,`HoraFim`,`Intervalo`,`Repeticao`) VALUES (4,4,'2012-03-05 00:00:00','8:01',NULL,'20:01',15,0) ; 
INSERT INTO GP_AGENDAMENTO (`idAgendamento`,`idRotina`,`DataInicio`,`HoraInicio`,`DataFim`,`HoraFim`,`Intervalo`,`Repeticao`) VALUES (6,6,'2012-03-05 00:00:00','8:01',NULL,'20:01',0,1) ; 
INSERT INTO GP_AGENDAMENTO (`idAgendamento`,`idRotina`,`DataInicio`,`HoraInicio`,`DataFim`,`HoraFim`,`Intervalo`,`Repeticao`) VALUES (7,7,'2012-03-05 00:00:00','0:00',NULL,'23:59',0,1) ; 
INSERT INTO GP_AGENDAMENTO (`idAgendamento`,`idRotina`,`DataInicio`,`HoraInicio`,`DataFim`,`HoraFim`,`Intervalo`,`Repeticao`) VALUES (8,8,'2012-03-05 00:00:00','0:00',NULL,'23:59',0,1) ; 
INSERT INTO GP_AGENDAMENTO (`idAgendamento`,`idRotina`,`DataInicio`,`HoraInicio`,`DataFim`,`HoraFim`,`Intervalo`,`Repeticao`) VALUES (9,9,'2012-03-05 00:00:00','0:00',NULL,'23:59',0,1) ; 
INSERT INTO GP_AGENDAMENTO (`idAgendamento`,`idRotina`,`DataInicio`,`HoraInicio`,`DataFim`,`HoraFim`,`Intervalo`,`Repeticao`) VALUES (10,10,'2012-03-05 00:00:00','0:00',NULL,'23:59',0,1) ; 
INSERT INTO GP_AGENDAMENTO (`idAgendamento`,`idRotina`,`DataInicio`,`HoraInicio`,`DataFim`,`HoraFim`,`Intervalo`,`Repeticao`) VALUES (11,11,'2012-03-05 00:00:00','0:00',NULL,'23:59',0,1) ; 
SET FOREIGN_KEY_CHECKS=1;
go
