...
{ 
    public sealed partial class #TABLEWITHOUTPREFIXTABLE##SUFFIXBLL#
    {
		...
		/// </summary>");
		public Int32 Insert(#TABLEWITHOUTPREFIXTABLE##SUFFIXENTITY# entity, NpgsqlTransaction oSqlTransaction)
		{		
			#TABLEWITHOUTPREFIXTABLE##SUFFIXDAL# o#TABLEWITHOUTPREFIXTABLE##SUFFIXDAL# = new #TABLEWITHOUTPREFIXTABLE##SUFFIXDAL#();
		...
		/// </summary>");
		public void Update(#TABLEWITHOUTPREFIXTABLE##SUFFIXENTITY# entity, NpgsqlTransaction oSqlTransaction)
		{		
			#TABLEWITHOUTPREFIXTABLE##SUFFIXDAL# o#TABLEWITHOUTPREFIXTABLE##SUFFIXDAL# = new #TABLEWITHOUTPREFIXTABLE##SUFFIXDAL#();
		...
		/// Delete a record from table #TABLEWITHOUTPREFIXTABLE# with transaction
		/// </summary>");
		public void Delete(#TABLEWITHOUTPREFIXTABLE##SUFFIXENTITY# entity, NpgsqlTransaction oSqlTransaction)
		{		
			#TABLEWITHOUTPREFIXTABLE##SUFFIXDAL# o#TABLEWITHOUTPREFIXTABLE##SUFFIXDAL# = new #TABLEWITHOUTPREFIXTABLE##SUFFIXDAL#();
