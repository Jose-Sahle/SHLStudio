...
namespace #NAMESPACEDAL#
{
    public static class SQLHelper
    {
        ...
        {
            #if(!DEBUG)
				return @"Data Source=#DATABASESERVERDEBUG#;User ID=#DATABASEUSERDEBUG#;password=#DATABASEPWDDEBUG#";
            #else
				return @"Data Source=#DATABASESERVER#;User ID=#DATABASEUSER#;password=#DATABASEPWD#";
			#endif
        }
