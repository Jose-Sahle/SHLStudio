...
//Search and Replace support
  ...
  virtual void ReplaceAllSel(_In_z_ LPCTSTR szFind, _In_z_ LPCTSTR szReplace, _In_ BOOL bNext, _In_ BOOL bCase, _In_ BOOL bWord, _In_ BOOL bRegularExpression);
