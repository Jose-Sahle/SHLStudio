...
//Auto generated using the "ConvertScintillaiface.js" script
  ...
  int CountCodeUnits(_In_ Sci_Position start, _In_ Sci_Position end);
  ...
  Sci_Position PositionRelativeCodeUnits(_In_ Sci_Position pos, _In_ int relative);
  ...
  int LineFromIndexPosition(_In_ Sci_Position posUTF32, _In_ int lineCharacterIndex);
