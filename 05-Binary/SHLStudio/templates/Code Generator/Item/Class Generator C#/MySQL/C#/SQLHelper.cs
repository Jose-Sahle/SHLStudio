...
namespace #NAMESPACEDAL#
{
    public static class SQLHelper
    {
        ...
        {
            #if(!DEBUG)
				return @"server=#DATABASESERVERDEBUG#;database=#DATABASECATAGLOGDEBUG#;User ID=#DATABASEUSERDEBUG#;password=#DATABASEPWDDEBUG#";
            #else
				return @"server=#DATABASESERVER#;database=#DATABASECATAGLOG#;User ID=#DATABASEUSER#;password=#DATABASEPWD#";
			#endif
        }
