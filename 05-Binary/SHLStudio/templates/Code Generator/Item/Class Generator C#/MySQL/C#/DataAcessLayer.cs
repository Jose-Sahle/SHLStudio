...
namespace #NAMESPACEDAL#
{
    public sealed partial class #TABLEWITHOUTPREFIXTABLE##SUFFIXDAL# : BaseDAL<#TABLEWITHOUTPREFIXTABLE##SUFFIXENTITY#>
    {
		...
		/// </summary>
		override public Int32 Insert(#TABLEWITHOUTPREFIXTABLE##SUFFIXENTITY# entity, MySqlTransaction oSqlTransaction)
		{
		...
		/// </summary>
		override public void Update(#TABLEWITHOUTPREFIXTABLE##SUFFIXENTITY# entity, MySqlTransaction oSqlTransaction)
		{
		...
		/// Delete a record from table #TABLEWITHOUTPREFIXTABLE# with transaction
		/// </summary>
		override public void Delete(#TABLEWITHOUTPREFIXTABLE##SUFFIXENTITY# entity, MySqlTransaction oSqlTransaction)
		{
