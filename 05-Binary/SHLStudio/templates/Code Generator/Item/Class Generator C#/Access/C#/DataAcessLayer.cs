...
namespace #NAMESPACEDAL#
{
	public sealed partial class #TABLEWITHOUTPREFIXTABLE##SUFFIXDAL# : BaseDAL<#TABLEWITHOUTPREFIXTABLE##SUFFIXENTITY#>
	{
		...
		public #TABLEWITHOUTPREFIXTABLE##SUFFIXENTITY# Select(Int32 pId)
		{
			...
			sbSQL.Append("FROM \n");
			sbSQL.Append("[#TABLE#] WITH (NOLOCK)\n");
			sbSQL.Append("WHERE \n");
			sbSQL.Append("([#PRIMARYKEY#] = pId");
		...
		public #TABLEWITHOUTPREFIXTABLE##SUFFIXENTITY# Select(#TABLEWITHOUTPREFIXTABLE##SUFFIXENTITY# entity)
		{
			...
			if(entity.#PRIMARYKEY# != null)
				sbSQLCriteria.Append("([#PRIMARYKEY#] = entity.#PRIMARYKEY#\n");
			...
			if(entity.#FIELD# != null)
			{
				...
				sbSQLCriteria.Append("([#FIELD#] = entity.#FIELD#\n");
			}
		...
		public Int32 Insert(OleDbTransaction oOleDbTransaction, #TABLEWITHOUTPREFIXTABLE##SUFFIXENTITY# entity)
		{
			...
			sbSQL.Append("(\n");
				<allfieldslessprimarykey>
			if(entity.#FIELD# != null)
				sbSQL.Append("#COMMABEFORE#entity.#FIELD#\n");
			else
				sbSQL.Append("#COMMABEFORE#NULL\n");
				</allfieldslessprimarykey>
			sbSQL.Append(")\n");		
		
			return Convert.ToInt32(SQLHelper.ExecuteNonQueryIdentity(sbSQL.ToString(), oOleDbTransaction));
		}
		...
		public void Update(OleDbTransaction oOleDbTransaction, #TABLEWITHOUTPREFIXTABLE##SUFFIXENTITY# entity)
		{
			...
			sbSQL.Append("SET \n");
				<allfieldslessprimarykey>
				if(entity.#FIELD# != null)
					sbSQL.Append("	#COMMABEFORE#[#FIELD#] = entity.#FIELD# \n");
				else
					sbSQL.Append("	#COMMABEFORE#[#FIELD#] = NULL \n");
					
				</allfieldslessprimarykey>
			sbSQL.Append("WHERE \n");
			sbSQL.Append("	[#PRIMARYKEY#] = entity.#PRIMARYKEY# \n");

			SQLHelper.ExecuteNonQuery(sbSQL.ToString(), oOleDbTransaction);
		}
		...
		public void Delete(OleDbTransaction oOleDbTransaction, Int32 pId)
		{
			...
			sbSQL.Append("WHERE [#PRIMARYKEY#] = pId \n");
